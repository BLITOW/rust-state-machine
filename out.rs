...
mod support {
    ...
    pub struct Block<Header, Extrinsic> {
        /// the block header contains metadate about the block.
        pub header: Header,
        /// The extrinsics represent the state transition to be executed int his block.
        pub extrinsics: Vec<Extrinsic>,
    }
    /// We are using an extremely simplified header which only contains the current block number.
    /// On a real blockchain, you would expect toalso find:
    /// - paren block hash
    /// - state root
    /// -extrinsics root
    /// - etc...
    ...
    /// The Result type for our runtime. When everything copletes successfully, we return 'Ok(())',
