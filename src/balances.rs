...
/// This function verifies that 'from' has at least 'amount'j balacnce to transfer
...
mod tests {
    ...
    fn transfer_balance() {
        ...
        assert_eq!(balances.transfer("alice".to_string(), "bob".to_string(), 51), Err("Not enough funds."));
    }
}